...
namespace diagnosisAnimal
{
    partial class Registration
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label8.Text = "Bạn chỉ được ghi 2 quyền là Experts Và User và viết đúng như vậy. Sau đó bằng các" +
    "h nhấp vào đăng ký bạn có thể đăng ký tài khoản thành công.";
